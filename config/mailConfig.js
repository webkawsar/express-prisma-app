...
const userEmailData = (to, token, password) => ({
    ...
    subject: 'Welcome to Express Prisma App',
    text: `Welcome from Express Prisma App.Please click the link to activate your account <a href="${process.env.HOST_ADDRESS}/auth/activate/${token}">Activate account</a>`,
    html: `<h3>Welcome from Express Prisma App</h3><p>Share your idea to the outer world</p><p>Please click the link to activate your account <a href="${process.env.HOST_ADDRESS}/auth/activate/${token}">Activate account</a></p> <h3>Your password is: <b>${password}</b></h3>`,
});
